...
public class MissingAlertCommentService : IMissingAlertCommentService
{
	...
	public async Task<AlertCommentResponse> GetAlertCommentByIdAsync(Guid commentId)
	{
	...
	public async Task<PaginatedEntity<AlertCommentResponse>> ListMissingAlertCommentsAsync(
